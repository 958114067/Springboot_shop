...
<div class="page-container">
    <A href="allnotice.do" style="color: #0f9ae0 ; font-size:15px; text-decoration:underline">全部公告</A>
    <form action="postnotice" method="post">
        <h3>公告标题</h3>
        ...
        <div style="text-align:center;padding:4px;">
            <input type="submit" value="发布公告" class="xiaowei">
        </div>
    </form>
</div>
<!--_footer 作为公共模版分离出去-->
