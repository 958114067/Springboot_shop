...
<body>
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-comments">
				<dt>
					<i class="Hui-iconfont">&#xe622;</i> 寝室管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="dorm_info?dorm_num=${eu.getE_dorm_num()}" data-title="寝室详细信息"
							href="javascript:;">寝室详细信息</a></li>
						<li><a data-href="inMoney?dorm_num=${eu.getE_dorm_num()}" data-title="电费充值"
							   href="javascript:void(0)">电费充值</a></li>
						<li>
						<li><a data-href="declare.do?dorm_num=${eu.getE_dorm_num()}" data-title="电器报修"
							   href="javascript:void(0)">电器报修</a></li>
						<li>
						<li><a data-href="topic.do" data-title="贴吧论坛"
							   href="javascript:void(0)">贴吧论坛</a></li>
						<li>
						<li><a data-href="moniyongdian.do?dorm_num=${eu.getE_dorm_num()}" data-title="模拟用电"
							   href="javascript:void(0)">30秒模拟用电</a></li>
						<li>
					</ul>
				</dd>
			</dl>
